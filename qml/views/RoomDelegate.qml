...
Model {
    ...
    geometry: ProceduralMesh {
        ...
        property var meshArrays: generateRoomSurface(roomPoints)
        ...
        function generateArcWall(roomPoints: variant, surfaceHeight: real): variant {
            let verts = []
            let normals = []
            let uvs = []
            let indices = []
